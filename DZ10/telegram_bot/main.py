...
def send_welcome(message):
    bot.send_message(message.chat.id, "Привет! Ввведи запрос для поиска в Википедии, чтобы начать. "+
                          "Историю, настройки и выбрать похожие статьи можно через меню,а также поменять язык")
